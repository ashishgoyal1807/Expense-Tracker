...
exports.addExpense = async (req, res, next) => {
  ...
  const income = ExpenseSchema({  //create instance of expenseSchema
    id,
    title,
    amount,
    category,
  ...
  try {
    ...
    const newIncome = await income.save(); // create entry of that instance income in db and if successfully
            // saved document is return and store in newIncome variable
